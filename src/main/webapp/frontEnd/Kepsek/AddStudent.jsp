        ...
        <div class="form-container">
            ...
            <form action="${pageContext.request.contextPath}/StudentServlet" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="user_id" class="form-control" id="user_id" placeholder="Masukkan User ID" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" id="name" placeholder="Masukkan nama siswa" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="enrollment_year" class="form-control" id="enrollment_year" placeholder="Masukkan tahun masuk" required>
                </div>

                <div class="mb-3">
                    <label for="class_id" class="form-label">ID Kelas (Opsional):</label>
                    <input type="number" name="class_id" class="form-control" id="class_id" placeholder="Masukkan ID kelas">
                </div>
