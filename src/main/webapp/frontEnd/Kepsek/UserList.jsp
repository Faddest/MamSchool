...
<head>
    ...
    <style>
        /* Tambahkan style sidebar, content, dan tabel dari template */
        body {
            display: flex;
            height: 100vh;
            margin: 0;
                ...
                <tbody>
                    <c:forEach var="user" items="${userList}">
                        <tr>
                            ...
                            <td>${user.role}</td>
                            <td>
                                <a href="UserServlet?action=edit&id=${user.id}" class="btn btn-warning btn-sm">
                                    <i class="bi bi-pencil"></i> Edit
                                </a>
                                <a href="UserServlet?action=delete&id=${user.id}" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus pengguna ini?');">
